      ...
      if (node.nodeName === 'DIV') {
        ...
        if (fightLog=="") {
		  ...
		  analyzeText(fightLog);
			...
			for(var i of team){var bruteSTR = '<font opacity="0.88" font-size="0.751429rem" color="'+(SOMBRE?'#DDABAA':'rgb(140, 81, 64)')+'"><b>'+i[1]+"</b></font>"+"\n"
			s+=bruteSTR
			}
			return s}
...
s=""
for(var i in sorted){
	s+='<font text-align="left" opacity="0.88" font-size="0.661429rem" color="'+(SOMBRE?'#DDABAA':'rgb(140, 81, 64)')+'">'+sorted[i]+"</font>"+"\n"
}
