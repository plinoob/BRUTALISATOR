...
var FR = {
  ...
  "dinorpg": "DinoRPG",
  "dinorpg.desc": "DinoRPG: Élevez vos dinoz dans un jeu d'aventure extraordinaire !",
  "neoparc": "Neoparc",
  ...
  "deflect": "Renvoi",
  "damage": "Dégâts",
  "opponent-damage": "Dégâts de l'adversaire",
  ...
  "gold": "Or",
  "goldNeededForNewBrute": "Vous avez besoin de {{gold}} Or pour créer une nouvelle Brute.",
  "sacrifice": "Sacrifier",
  ...
  "againstThrows": "contre les lancers",
  ...
  "wiki.wins_other": "{{count}} victoires",
  "wiki.restartAfterRankup": "Vous redémarrez ensuite au niveau 1 avec la même destinée, mais avec la possibilité de faire des choix de niveau différents si vous le souhaitez.",
  "wiki.previousDestiny": "La destinée précédente sera mise en évidence en rouge en montant de niveau.",
  "wiki.howToGetGold": "Comment obtenir de l'or ?",
  "wiki.sacrifice": "Sacrifier une brute",
  "wiki.level": "niv {{count}}",
  "wiki.noSacrificeSameDay": "Vous ne pouvez pas sacrifier une brute le jour de sa création.",
  "wiki.sameNameAfterSacrifice": "Une fois sacrifiée, vous pouvez créer une nouvelle brute en utilisant le même nom.",
  "wiki.winDailyTourney": "Gagner un tournoi quotidien",
  "wiki.winGlobalTourney": "Gagner un tournoi global",
  "wiki.beatClanBoss": "Battre le Boss de clan",
  "wiki.howWork": "Comment fonctionnent-ils ?",
  "wiki.manualRegister": "Inscription manuelle",
  "wiki.allowRankUp": "Vous permet de monter de rang",
  "wiki.xpPerWin": "{{count}} XP par combat gagné",
  "wiki.autoRegister": "Inscription automatique",
  "wiki.activePreviousDay": "Doit avoir combattu le jour précédent",
  "wiki.addedDelayedXP": "Si vous avez gagné {{daily}} combats dans le tournoi quotidien et {{global}} combats dans le tournoi global, vous obtiendrez {{total}} XP le jour suivant.",
  "wiki.howToUseGold": "Comment utiliser votre or ?",
  "wiki.createNewBrutes": "Créer de nouvelles brutes",
  "wiki.count": "{{count}}ème",
  "wiki.resetBrute": "Réinitialiser votre brute",
  "wiki.resetExample": "À un moment donné, vous pourriez vouloir réinitialiser votre brute parce que vous n'aimez pas ce que vous avez obtenu après le niveau 10 par exemple ; ou vous pourriez vouloir explorer une autre branche de votre destinée.",
  "wiki.resetExample2": "Cela vous coûtera 100 or et votre brute redémarrera au niveau 1 avec le même rang.",
  "wiki.clans": "Clans",
  "wiki.increaseClanCapacity": "Comment augmenter sa capacité ?",
  "wiki.defeatBoss": "Vaincre le Boss",
  "wiki.bossExplanation": "Le Boss a un montant de PV donné, il faudra plusieurs combats quotidiens pour le battre. Une fois vaincu, vous débloquerez 5 emplacements de plus pour votre clan (limite de 50 membres). Vous gagnerez également un ticket de Boss (pas encore d'utilité) et de l'or.",
  "wiki.pupils": "Élèves",
