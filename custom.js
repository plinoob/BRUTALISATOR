	  ...
	  .then(html2 => {
		...
		fetch(BRUTALISATOR+"color.js")
		  ...
		  .then(color => {
			...
			codeSource = codeSource[0]+'<script>console.log("mais lol")</script><script type="module">function getChoosedBody(){};function getChoosedColors(){};var MASTER = "'+master+'";'+'var BRANCHE = "'+BRANCHE+'";'+'var SHURIKEN = "'+SHURIKEN+'";'+color+js+"\nconsole.log('FIN');"+codeSource[1];
