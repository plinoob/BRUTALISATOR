...
function clickOnTournoi(){cl("CHECKTOURNOI");var elem = findFirstTextInDOM("Tournoi","button");cl(elem,clickedOnTournoi);if(elem && !clickedOnTournoi){clickedOnTournoi=true;$(elem).click()}}
